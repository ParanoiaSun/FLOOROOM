...
public class JPanelAchievement extends JPanel implements Runnable{
	...
	private int page = 0;
	private JPanelAchievementNext achievementnext;
	private int imageindex;

	
	public JPanelAchievement(JMainFrame jframe){
	...
	public void run() {
		...
		this.initialButtons();
		achievementnext = new JPanelAchievementNext(jMainFrame);
		this.repaint();
	}
	...
	class ButtonListenerau extends MouseAdapter implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			case 0:
				...
				achievementnext.setDirection(false);
				new Thread(achievementnext).start();
				break;
			case 1:
				b.play();
				page++;
				...
				achievementnext.setDirection(true);
				new Thread(achievementnext).start();
				break;
			case 2:
				b.play();
