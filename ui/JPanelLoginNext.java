...
public class JPanelLoginNext extends JPanel implements Runnable{
	...
	class ButtonListenerln extends MouseAdapter implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			AudioPlayer1 b=new AudioPlayer1("sound/homebutton.wav");
	...
	class closingThread implements Runnable{
		...
		public void run() {
			...
			case 1:
				@SuppressWarnings("unused")
				JPanelSetting jps = new JPanelSetting(jMainFrame);
				
				break;
			case 2:
				@SuppressWarnings("unused")
				JPanelAchievement ja = new JPanelAchievement(jMainFrame);
				
				break;
			case 3:
				@SuppressWarnings("unused")
				JPanelAboutUs jau = new JPanelAboutUs(jMainFrame);
